module github.com/cirruslabs/vagrant-tart

go 1.19

require github.com/hashicorp/vagrant-plugin-sdk v0.0.0-20220727201406-96c2d23105d3
...
require (
	...
	github.com/mitchellh/go-glint v0.0.0-20200930000256-df5e721f3258 // indirect
